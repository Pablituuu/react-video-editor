...
export default function MenuList() {
  ...
  return (
    <div
      style={{ zIndex: 201 }}
      className="w-14 py-2 absolute top-1/2 -translate-y-1/2 mt-6 left-2.5 bg-background/80 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg flex flex-col   items-center"
    >
      <Button
        onClick={() => {
