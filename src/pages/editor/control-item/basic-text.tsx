  ...
  return (
    <div className="flex gap-2">
      <Popover>
        <PopoverTrigger asChild>
          <div
            ...
            className="h-9 w-9 cursor-pointer border border-border flex-none rounded-md"
          ></div>
        </PopoverTrigger>
        <PopoverContent className="w-full  z-[300] p-0">
          <ColorPicker
            value={localValue}
            format="hex"
            gradient={true}
      ...
      <div className="relative">
        ...
        />
        <div className="absolute top-1/2 transform -translate-y-1/2 right-2.5 text-sm text-muted-foreground">
          hex
        </div>
      </div>
    </div>
